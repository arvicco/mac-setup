...
- **Setup modules** (Homebrew, Shell, etc.) — these are thin wrappers around shell commands. Test only non-trivial logic (e.g., conditional install paths, idempotency checks). Do not mock shell commands just for coverage
